...
namespace physics {
    ...
    bool CollisionManager::CheckCollision(const PhysicsBody& bodyA, const PhysicsBody& bodyB) {
    ...
    void CollisionManager::CollisionResponse(PhysicsBody& bodyA, PhysicsBody& bodyB) {
