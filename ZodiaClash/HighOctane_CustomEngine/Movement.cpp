...
void UpdateMovement(Transform & transform, Model & model) {	
	...
	for (Postcard const & msg : Mail::mail().mailbox[ADDRESS::MOVEMENT]) {
		...
		case TYPE::KEY_DOWN:
			...
			switch (msg.info) {
			case INFO::KEY_W:   case INFO::KEY_UP:      direction = { RESET_VEC2 }; transform.force.y = 1000; break;
			case INFO::KEY_S:   case INFO::KEY_DOWN:    direction = { RESET_VEC2 }; transform.force.y = -1000; break;
			case INFO::KEY_A:   case INFO::KEY_LEFT:    direction = { RESET_VEC2 }; transform.force.x = -1000; break;
			case INFO::KEY_D:   case INFO::KEY_RIGHT:   direction = { RESET_VEC2 }; transform.force.x = 1000; break;
